...
class CodeInjector:
    ...
    def about(self):
        ...
        print(colored("                                                                           ", "green"))
        print(colored("# ==============================================================================", "green"))
        print(colored("# author      	:", "green") + "darkboss1")
        print(colored("# web    	:", "green") + "https://www.serialkey.top")
        print(colored("# github      	:", "green") + "https://github.com/darkboss1")
        print(colored("# date        	:", "green") + "02.07.2025")
        print(colored("# version     	:", "green") + "2.1")
        print(colored("# python_version:",  "green") + "3.8.2")
        print(colored("# ==============================================================================", "green"))
